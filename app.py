...
UI_TRANSLATIONS = {
    "en": {
        ...
        "suspicious_message": t["suspicious_message"],
        "url_description": t["url_description"],
        "call_description_label": t["call_description_label"],
        ...
        "timezone": "🕐 Timezone",
        "lookup_unavailable": t["lookup_unavailable"],
        "lookup_detail": "Lookup detail",
        "risk_evidence": t["risk_evidence"],
        "behavior_risk": t["behavior_risk"],
        "calls_received": t["calls_received"],
        "overall_risk": t["overall_risk"],
        "telecom_assessment": t["telecom_assessment"],
        "telecom_not_verdict": t["telecom_not_verdict"],
        "quiz_description": t["quiz_description"],
        "correct": t["correct"],
        "incorrect": t["incorrect"],
        "select_answer": t["select_answer"],
        "perfect_score": t["perfect_score"],
        "report_scam_title": t["report"],
        "raw_response": t["raw_response"],
        "groq_error": "Groq API Error",
        "parse_error": t["parse_error"],
        "enter_message": t["enter_message"],
        "enter_url": t["enter_url"],
        "enter_phone": t["enter_phone"],
        "safe_label": "Safe",
        "suspicious_label": "Suspicious",
        "scam_label": "Scam",
        "english": "English",
        "report": t["report"],
        "footer_model": t["footer_model"],
    },
    "te": {
        "language_label": "భాష",
        "mission": "మా లక్ష్యం",
...
def calculate_call_risk(phone_info, call_count, call_description):
    """
    Deterministic risk signals from telecom metadata + caller behavior.
...
with tab3:
    ...
    call_description = st.text_area(
        ...
        placeholder=(
            t["call_description_placeholder"]
        ),
        height=130,
...
1. Telecom metadata supplied by a phone intelligence provide.
